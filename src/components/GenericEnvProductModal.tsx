...
type GenericEnvProductModalProps = Omit<Props, 't'>;

const TranslatedGenericEnvProductModal: React.ComponentType<GenericEnvProductModalProps> =
  withTranslation()(GenericEnvProductModal);

export default TranslatedGenericEnvProductModal;
