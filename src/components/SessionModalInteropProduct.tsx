...
type SessionModalInteropProductProps = Omit<Props, 't'>;

const TranslatedSessionModalInteropProduct: React.ComponentType<SessionModalInteropProductProps> =
  withTranslation()(SessionModalInteropProduct);

export default TranslatedSessionModalInteropProduct;
