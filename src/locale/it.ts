export default {
  ...
  onboardingsPage: {
    ...
    filters: {
      ...
      createdFromDate: 'Dal',
      createdToDate: 'Al',
      updateDate: "DATA DI ADESIONE",
      updateDateTooltip: 'Data in cui il prodotto è stato attivato o disattivato',
      statusUpdatedFromDate: 'Dal',
      statusUpdatedToDate: 'Al',
    ...
    table: {
      ...
      requestDate: 'Data di richiesta',
      statusUpdatedAt: 'Data di adesione',
      requestDateTooltip: 'Data in cui l\'ente ha fatto la richiesta di adesione al prodotto',
      statusUpdatedAtTooltip: 'Data in cui l\'ente è diventato attivo per il prodotto o è stato disattivato',
      status: "Stato dell'accordo",
