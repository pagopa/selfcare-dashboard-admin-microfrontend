...
export type ProductRolesByProductRoleType = {
  [productRole: string]: ProductRole;
};
export type ProductRolesBySelcRoleType = {
  [selcRole in UserRole]: Array<ProductRole>;
};
export type ProductRolesByPartyRoleType = {
...
export const productRoles2ProductRolesList = (
